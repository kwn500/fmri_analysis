function extractpRFdata_P1361(prf_dir, participantnumber, participant, ROIanalysis, outputROI)
...
elseif isequal(participant, 'R4833')
    anat = '/scratch/groups/Projects/P1361/fMRI/R4833/anatomy/t1.nii.gz';
    VOLUME{1} = mrVista('3view', anat);
elseif isequal(participant, 'R5006')
    anat = '/scratch/groups/Projects/P1361/fMRI/R5006/anatomy/t1.nii.gz';
    VOLUME{1} = mrVista('3view', anat);
else
...
if isequal(participant, 'R3111') && isequal(outputROI, 'MT+')
    ROI_directory = sprintf('/scratch/groups/Projects/P1361/fMRI/%S/anatomy/MT/ROIs/', participant);
else
    ROI_directory = sprintf('/scratch/groups/Projects/P1361/fMRI/%s/anatomy/ROIs/', participant);
end
